...
# URL: http://www.codeskulptor.org/#user27_Ib9noyVb50_4.py
...
rush = simplegui.load_sound("https://www.dropbox.com/s/n7y8gh2kyg8ug73/Rush-Tom-Sawyer.ogg?dl=1")
...
def rock_spawner():
    ...
    a_rock = Sprite([random.random() * WIDTH, random.random() * HEIGHT], 
                    ...
                    random.random() * 0.1, asteroid_image, asteroid_info)

def keydown(key):
    
    if key == simplegui.KEY_MAP["up"]:
        my_ship.check_thrust()
        print "accelerate";
